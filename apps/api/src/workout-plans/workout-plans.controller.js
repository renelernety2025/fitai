...
let WorkoutPlansController = (() => {
    let _classDecorators = [Controller('workout-plans'), UseGuards(JwtAuthGuard)];
    ...
    var WorkoutPlansController = _classThis = class {
    ...
    (() => {
        ...
        __esDecorate(_classThis, null, _clone_decorators, { kind: "method", name: "clone", static: false, private: false, access: { has: obj => "clone" in obj, get: obj => obj.clone }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        WorkoutPlansController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return WorkoutPlansController = _classThis;
})();
