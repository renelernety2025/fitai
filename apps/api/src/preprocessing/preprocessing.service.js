...
function getMockChoreography(videoId) {
    return {
        video_id: videoId,
        poses: [
            {
...
let PreprocessingService = (() => {
    ...
    let _classThis;
    var PreprocessingService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
            this.logger = new Logger(PreprocessingService.name);
            this.s3Client = null;
        ...
        async runPipeline(videoId, jobId) {
            try {
        ...
        async stepTranscribe(videoId, jobId) {
            ...
            try {
                // Download from S3
                if (this.s3Client) {
                    const obj = await this.s3Client.send(new GetObjectCommand({ Bucket: this.bucket, Key: video.s3RawKey }));
        ...
        async stepExtractChoreography(videoId, jobId, transcript) {
...
pro nejdůležitější kloub dané pózy.`;
        ...
        async stepSaveResult(videoId, jobId, choreography) {
    ...
    __setFunctionName(_classThis, "PreprocessingService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PreprocessingService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PreprocessingService = _classThis;
})();
export { PreprocessingService };
