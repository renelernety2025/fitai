...
import { V2Screen, V2Display, V2SectionLabel, V2Stat, V2Loading, v2 } from '../components/v2/V2';
...
export function JidelnicekScreen() {
  ...
  useEffect(() => {
    getCurrentMealPlan()
      ...
      .catch(() => setPlan(null)) // empty body or error → no plan
  ...
  if (loading) {
    return <V2Screen><V2Loading /></V2Screen>;
  }
